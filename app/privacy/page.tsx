...
export default function PrivacyPage() {
  return <main className="legal-page"><div className="legal-shell">
    ...
    <article className="legal-card">
      ...
      <section><h2>Anonymous journey measurement</h2><p>MetaForge asks before enabling optional journey measurement and affiliate tracking. If allowed, MetaForge assigns a random anonymous browser identifier and records broad actions such as visiting, starting or completing a Forge, opening coaching, beginning a test, or choosing to save. Campaign labels may also be retained for attribution. MetaForge does not include decklists, card choices, names, email addresses, or advertising profiles in these events. Declining does not limit the Forge.</p></section>
      <section><h2>Your choices</h2><p>You may decline optional measurement and still use MetaForge. You may avoid creating an account and use only the one-time preview. You can clear the saved measurement choice through your browser storage controls. You may request access, correction, or deletion of account information by contacting support.</p></section>
