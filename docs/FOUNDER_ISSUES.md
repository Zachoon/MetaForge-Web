...
*Last updated: 2026-08-19 — #029 shipped: archetype-catalog batch 2 adds 6 more declarative packages (lifegain, lands matter, burn, enchantress, mill, wheels) on top of #028's proof of concept, plus one new shared false-friend shape (`wrong-target-scope`, reused by both mill and wheels — verified genuinely shared, not archetype-specific). 104-forge field: pass 100%, hard failures 0, no hard regressions against the frozen baseline. All 9 pre-existing archetype/package occupancy tests plus `validate:founder-026`/`validate:founder-027` re-verified green with zero behavior change to any existing entry.*
