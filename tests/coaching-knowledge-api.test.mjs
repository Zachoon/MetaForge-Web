...
// Auth mechanism itself is covered separately (see access-identity.test.mjs);
// this file exercises coaching-knowledge review logic, so it uses the
// explicitly-gated local dev bypass to authenticate.
...
const req=(path,method,email,body)=>new Request(`https://test${path}`,{method,headers:{"x-dev-user-email":email,"content-type":"application/json"},body:body?JSON.stringify(body):undefined});
