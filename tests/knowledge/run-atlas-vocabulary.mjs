...
function main() {
  ...
  const report = [
    ...
    `| Reanimator seats | ${registry.summary.reanimatorSeatCount} |`,
    `| Landfall occupancy seats | ${registry.summary.landfallOccupancySeatCount} |`,
    `| Stax seats | ${registry.summary.staxSeatCount} |`,
